        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PostponementOfCaccination = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PostCaccinationReaction = table.Column<string>(type: "nvarchar(max)", nullable: false),
